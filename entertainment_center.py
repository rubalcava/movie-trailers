...
toy_story = media.Movie('Toy Story',
                        'A story of a boy and his toys that come to life', 'http://upload.wikimedia.org/wikipedia/en/1/13/Toy_Story.jpg', 'https://www.youtube.com/watch?v=KYz2wyBy3kc')
...
lion_king = media.Movie('The Lion King',
                     'Embark on an extraordinary coming-of-age adventure as Simba, a lion cub who cannot wait to be king',
...
little_mermaid = media.Movie('The Little Mermaid',
                     "A rebellious 16-year-old mermaid Ariel is fascinated with life on land",
